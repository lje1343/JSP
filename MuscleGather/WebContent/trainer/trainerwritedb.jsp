...
int flag1 = 1;
if(chk == 1){ 
   flag1 = dao.trainerInsert(user_no, trainer_title, trainer_content, trainer_addr, arr);
} else {
   flag1 = dao.trainerInsert(user_no, trainer_title, trainer_content, trainer_addr);
}
