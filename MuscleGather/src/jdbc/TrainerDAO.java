...
public class TrainerDAO {
	...
	public int trainerInsert(String user_no, String trainer_title, String trainer_content, String trainer_addr, ArrayList<String> arr)
			...
			public int trainerInsert(String user_no, String trainer_title, String trainer_content, String trainer_addr)
					throws NamingException
					{
