   ...
   <div class="bodydiv">
      ...
      <table class="table table-hover">
         ...
         <tbody>
            ...
            int nbr_of_row = 0;                  	//게시물의 총 수, 사람의 총 수, 테이블  하나 전체의 갯수
           ...
           /*  /****************************** 페이지 제어/ */
            ...
            if(block_endpage_no < nbr_of_page) {
            	// 다음 블럭 시작 페이지
            	next_block_start_page_no = block_endpage_no + 1;
