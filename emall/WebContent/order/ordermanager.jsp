...
<div align = "right">
<a href="orderstatis.jsp?status=1">[입금전]</a>		
<a href="orderstatis.jsp?status=2">[입금완료]</a>		
<a href="orderstatis.jsp?status=3">[배송중]</a>		
<a href="orderstatis.jsp?status=4">[배송완료]</a>
</div>
...
<% } %>
    ...
    <a href="product/productadd.jsp">글쓰기</a>
