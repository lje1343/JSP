...
public class GymDTO extends UserDTO{
	...
	/*
	 * public GymDTO() {;} // 자바빈즈용 기본 생성자 //자식 클래스로 빈즈사용이 되는지는 모름. 테스트 필요
	 * 
	 */
	
	
	/*
	 * //전체(부모클래스 필드를 포함한) 매개변수를 받는 생성자 -> 다른 매개변수의 생성자 필요시 오버로딩 public GymDTO(int
	 * user_no, String user_name, String user_pw, String user_birth, String
	 * user_zipcode, String user_addr, String user_addrdetail, boolean user_gender,
	 * String user_email, String user_phone, boolean user_admin, boolean user_kakao,
	 * String user_auth, boolean user_status, int gym_no, String gym_name, String
	 * gym_content, String gym_addr, int gym_salary, boolean gym_secret, String
	 * gym_regdate, String gym_images) { super(user_no, user_name, user_pw,
	 * user_birth, user_zipcode, user_addr, user_addrdetail, user_gender,
	 * user_email, user_phone, user_admin, user_kakao, user_auth, user_status);
	 * this.gym_no = gym_no; this.gym_name = gym_name; this.gym_content =
	 * gym_content; this.gym_addr = gym_addr; this.gym_salary = gym_salary;
	 * this.gym_secret = gym_secret; this.gym_regdate = gym_regdate; this.gym_images
	 * = gym_images; }
	 * 
	 */

	// gymlist.jsp
	public GymDTO(int gym_no, String gym_name, String gym_content, String gym_addr, int gym_salary, boolean gym_secret,
			String gym_regdate, String gym_images) {
		this.gym_no = gym_no;
